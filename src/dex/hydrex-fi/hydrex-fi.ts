...
import { HydrexFiData } from './types';
import { SimpleExchange } from '../simple-exchange';
import { HydrexFiConfig } from './config';
import { HydrexFiEventPool } from './hydrex-fi-pool';

export class HydrexFi extends SimpleExchange implements IDex<HydrexFiData> {
  protected eventPools: HydrexFiEventPool;
  ...
  constructor(
    ...
    this.eventPools = new HydrexFiEventPool(
      dexKey,
      network,
      dexHelper,
      this.logger,
  ...
  getCalldataGasCost(poolPrices: PoolPrices<HydrexFiData>): number | number[] {
